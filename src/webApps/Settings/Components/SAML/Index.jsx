...
import CustomStyles from "../../../../assets/styles/Settings_styles/SAML/IndexStyle";
...
const Index = props => {
  ...
  return (
    <div style={{ width: "100%", padding: "40px 0px" }}>
      <Grid container spacing={24} style={{ paddingBottom: "30px" }}>
...
export default withTranslation()(
  withStyles(CustomStyles, { withTheme: true })(Index)
);
