...
class AdministrationFields extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      rowsPerPage: 10,
      dataAttribute: [],
      entity: entity ? entity : location.state.option,
  ...
  render() {
    const { classes, theme, t, subEntity } = this.props;
    const {
      attributesCount,
      rowsPerPage,
      page,
    ...
    const filteredCustomFields = customFields[type]
      ? customFields[type].filter(
          (field) => field.visibility[AMStuiteEnums.TypeEnum[subEntity]] !== undefined
        )
      : [];
    return (
        ...
        <div className={classes.fill}>
          ...
          <Paper elevation={2} className={classes.paper}>
            ...
            <TablePagination
              ...
              component="div"
              count={filteredCustomFields ? filteredCustomFields.length : 0}
